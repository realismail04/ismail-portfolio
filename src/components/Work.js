...
const workData = [
  {
    img: "img/projects/interior designer.png",
    name: "Luxe Interiors",
    industry: "Interior Design",
    category: "Portfolio Showcase",
    techUsed: ["Next.js", "High-Res Image Optimization", "CSS Grid"],
    skillsUsed: ["Visual Storytelling", "High-End Gallery UI", "Branding"],
  },
  {
    img: "img/projects/Twanya Hood Hill.png",
    name: "Twanya Hood Hill",
    industry: "Professional Services",
    category: "Speaker & Coaching Website",
    techUsed: ["Wix", "Premium Design", "Velo"],
    skillsUsed: ["Personal Branding", "Booking Flow", "Interactive UI"],
  },
  {
    img: "img/projects/Mary Ellen Sherlock Author Website.png",
    name: "Mary Ellen Sherlock",
    industry: "Publishing",
    category: "Author Portfolio",
    techUsed: ["WordPress", "Custom Branding", "Email Integration"],
    skillsUsed: ["Content Strategy", "Author Branding", "Mobile Optimization"],
  },
  {
    img: "img/projects/Bordership.png",
    name: "Bordership",
    industry: "Logistics",
    category: "Courier & Shipping Website",
    techUsed: ["WordPress", "Elementor", "Custom Tracking"],
    skillsUsed: ["Global Logistics UI", "Tracking System Integration", "Responsive Design"],
  },
  {
